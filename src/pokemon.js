class Pokemon {
    ...
    */  /// tried to use getter (get syntax) and I know its supposed to work but just for the sake of the testing I wanted to used the regular syntax to ensure I am getting question correct.
    getHealth() {
        return this.#health;
    }
